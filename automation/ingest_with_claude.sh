...
echo ""
echo "2. Use the ingest-url command:"
echo -e "   ${YELLOW}/ingest-url${NC}"
echo ""
echo "3. When Claude asks, provide this URL:"
echo -e "   ${YELLOW}$URL${NC}"
echo ""
echo "4. Claude will:"
echo "   - Fetch and analyze the content"
echo "   - Update the appropriate section files"
echo "   - Show you what was added"
echo ""
echo "5. Review the changes:"
echo -e "   ${YELLOW}git diff${NC}"
echo ""
echo "6. If you're happy, commit:"
